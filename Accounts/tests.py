...
class UserAuthenticationTests(TestCase):
    def setUp(self):
        ...
        self.user_data = {
            ...
            "last_name": "Doe",
            "user_profile": {
                "Manager's location: country": "Ethiopia",
                "Manager's location: region": "Addis Ababa",
                "Manager's location:zone": "Addis Ababa",
                "Manager's location: woreda": "03",
                "Manager's location: kebele": "01",
                "Phone number": "0934678965"
            },
            "user_company": {
                "company name": "Akotet PLC",
                "Manager's location: country": "Ethiopia",
                "Manager's location: region": "Addis Ababa",
                "Manager's location:zone": "Addis Ababa",
                "Manager's location: woreda": "03",
    ...
    def test_user_login_invalid_credentials(self):
        ...
        invalid_login_response = self.client.post(self.login_url, invalid_login_data, format='json')
    ...
    def test_user_token_refresh_invalid_token(self):
        ...
        invalid_refresh_response = self.client.post(self.refresh_url, invalid_refresh_data, format='json')
